...
test("Selected mode is preserved across sessions", async ({ page }) => {
	...
	// bits-ui menus auto-close on select and the trigger toggles, so make
	// sure the menu is closed before opening it again (upstream relied on
	// next-themes/Radix-specific open/close semantics here).
